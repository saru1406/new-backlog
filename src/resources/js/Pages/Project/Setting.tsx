...
export default function ProjectSetting({
    ...
    const handleSubmitUser: FormEventHandler = (e) => {
        e.preventDefault();
        userForm.post(route('users.store', project.id), {
            onSuccess: () => {
                closeModal('user');
                userForm.reset();
            },
    ...
    const handleDeleteType = (e:React.MouseEvent<HTMLSpanElement, MouseEvent> , type: Type) => {
        e.preventDefault();
        router.delete(route('types.destroy', [project.id, type.id]))
    }

    const handleDeletePriority = (e:React.MouseEvent<HTMLSpanElement, MouseEvent> , priority: Priority) => {
        e.preventDefault();
                            ...
                            >
                                <tr>
                                    ...
                                    <td className='py-3 px-5 text-center text-red-500'>
                                        <span onClick={(e) => handleDeleteType(e, type)} className='cursor-pointer'>
                                            ✕
                                        </span>
                                    </td>
                                </tr>
                            ...
                            >
                                <div>
                                    <div>
                                        ...
                                        <TextInput
                                            className='w-5/6'
                                            value={priorityForm.data.priority_name}
                                            onChange={(e) =>
                                    ...
                                    <div className='my-5'>
                                        ...
                                        >
                                            {priorityForm.processing ? '作成中...' : '作成'}
                                        </PrimaryButton>
                                    </div>
                                </div>
                            </form>
                        ...
                        {priorities.map((priority) => (
                            ...
                            >
                                <tr>
                                    ...
                                    <td className='py-3 px-5 text-center text-red-500'>
                                        <span onClick={(e) => handleDeletePriority(e, priority)} className='cursor-pointer'>
                                            ✕
                                        </span>
                                    </td>
                                </tr>
                            ...
                            >
                                <div>
                                    <div>
                                        ...
                                        <TextInput
                                            className='w-5/6'
                                            value={userForm.data.project_name}
                                            onChange={(e) =>
                                                userForm.setData(
                                                    'project_name',
                                                    e.target.value
